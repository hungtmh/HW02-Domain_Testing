...
Append vào: `23127259/reports/AI_Audit_Report.md`

Nếu chưa có, tạo với header:

```markdown
# AI Audit Report — MSSV 23127259 — HW02
...
1. Đọc file `23127259/reports/AI_Audit_Report.md` để đếm số lượng Interaction hiện tại.
...
Lưu riêng: `23127259/reports/AI_Critique.md`
...
Ghi nhận AI Gap Analysis vào file báo cáo chính: **`23127259/reports/Main_Report.md`** tại mục:
